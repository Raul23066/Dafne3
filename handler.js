...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*Advertencia*', body: 'DAFNESITA BOT ⚙️', thumbnail: imagen1, sourceUrl: 'https://chat.whatsapp.com/JFmzWDhwDjW52Ouhh77Few'}}}}, aa);
